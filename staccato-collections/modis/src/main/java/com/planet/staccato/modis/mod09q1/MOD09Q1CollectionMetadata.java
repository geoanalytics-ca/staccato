...
@Data
public class MOD09Q1CollectionMetadata extends CollectionMetadataAdapter<MOD09Q1ItemProperties> {
    ...
    public MOD09Q1CollectionMetadata() {
        super();
        ...
        properties = new MOD09Q1ItemProperties();
    ...
    private void buildProviders() {
        ...
        providers.add(Provider.build()
                .name("LP-DAAC")
                .addRole(Provider.Role.PRODUCER)
                .url("https://lpdaac.usgs.gov/products/mod09q1v006/"));
    }
