...
// !!
@Data
@JsonTypeName("mod09gq_high_quality")
@JsonDeserialize(as = MOD09GQHQItemProperties.class)
public class MOD09GQHQItemProperties implements CoreProperties, EO, Projection, MOD09GQHQ {
    // CoreProperties
