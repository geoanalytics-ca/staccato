...
// !!
@Data
public class MOD09GQVegEVI2CollectionMetadata extends CollectionMetadataAdapter<MOD09GQVegEVI2ItemProperties> {
    // !!
    public static final String ID = "modis.mod09gq.veg.evi2";
    public static final String TITLE = "MODIS MOD09GQ EVI2 Vegetative Index";
    ...
    public static final String[] KEYWORDS = {"modis", "modis-terra", "modis-aqua", "terra", "aqua", "MOD09GQ", "veg", "EVI2"};
    public static final String CRS = "http://www.opengis.net/def/crs/OGC/1.3/CRS84";

    // !!
    public MOD09GQVegEVI2CollectionMetadata() {
        super();
        ...
        // !!
        properties = new MOD09GQVegEVI2ItemProperties();
        buildProperties();
        buildProviders();
    }
