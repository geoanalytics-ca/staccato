...
// !!
@Data
public class MOD09GQHQCollectionMetadata extends CollectionMetadataAdapter<MOD09GQHQItemProperties> {
    // !!
    public static final String ID = "modis.mod09gq.highquality";
    public static final String TITLE = "MODIS MOD09GQ Band 1 High Quality Index";
    ...
    // !!
    public MOD09GQHQCollectionMetadata() {
        super();
        ...
        // !!
        properties = new MOD09GQHQItemProperties();
        buildProperties();
        buildProviders();
    }
