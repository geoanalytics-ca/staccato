...
// !!
@Data
public class MOD09GQVegNDVICollectionMetadata extends CollectionMetadataAdapter<MOD09GQVegNDVIItemProperties> {
    // !!
    public static final String ID = "modis.mod09gq.veg.ndvi";
    public static final String TITLE = "MODIS MOD09GQ NDVI Vegetative Index";
    ...
    // !!
    public MOD09GQVegNDVICollectionMetadata() {
        super();
        ...
        // !!
        properties = new MOD09GQVegNDVIItemProperties();
        buildProperties();
        buildProviders();
    }
