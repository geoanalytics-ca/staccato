...
// !!
@Data
@JsonTypeName("mod09gq_evi2")
@JsonDeserialize(as = MOD09GQEVI2ItemProperties.class)
public class MOD09GQEVI2ItemProperties implements CoreProperties, EO, Projection, MOD09GQEVI2 {
    // CoreProperties
